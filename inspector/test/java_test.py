...
class TestJavaParse(unittest.TestCase):
    ...
    def test_parse_3(self):
        ...
        self.assertEqual(sf.get_class('Point').get_method('clear').lines_count, 5)
        self.assertEqual(sf.get_class('Pixel').get_method('clear').lines_count, 4)
        self.assertEqual(sf.next_token(), None)
    ...
    def test_parse_4(self):
        ...
        self.assertEqual(sf.get_class('SimpleLookup').get_method('processValues').lines_count, 7)
        self.assertEqual(sf.next_token(), None)
